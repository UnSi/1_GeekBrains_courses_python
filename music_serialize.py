...
#
# С помощью модулей json и pickle сериализовать данный словарь в json и в байты, вывести результаты в терминал. Записать результаты в файлы group.json, group.pickle соответственно.
...
json_mfg = json.dumps(my_favourite_group)
pickle_mfg = pickle.dumps(my_favourite_group)

print(json_mfg)
print(pickle_mfg)
with open("group.json", "w", encoding="utf-8") as f:
    # for k, v in my_favourite_group.items():
    #     json.dump(k.encode("utf-8"))
    #     json.dump(k.encode("utf-8"))
